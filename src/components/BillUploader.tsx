...
export default function BillUploader({ onSuccess, onError }: BillUploaderProps) {
  ...
  const handleManualBillCreation = () => {
    // Start with a few default items
    const defaultItems: ExtractedItem[] = [
      { item_name: 'Item 1', quantity: 1, unit_price: 0 },
      { item_name: 'Item 2', quantity: 1, unit_price: 0 }
    ];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Your Bill</h1>
        <p className="text-gray-600">Upload an image of your restaurant bill or create one manually</p>
      </div>
          ...
          {!ocrResults ? (
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Create Bill Manually</h3>
                  <p className="text-gray-600 mb-4">
                    Start with a blank bill and add items manually
                  </p>
                  <button
                    onClick={handleManualBillCreation}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Add and edit your bill items below, then confirm to proceed.
                  </p>
                </div>
                <button
                  onClick={resetUploader}
