...
export default function SummaryView({ onReset }: SummaryViewProps) {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.text('FairShare - Bill Split Summary', pageWidth / 2, y, { align: 'center' });
      y += 20;
      ...
      pdf.text('Generated by FairShare', pageWidth / 2, y, { align: 'center' });
      y += 5;
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">FairShare Summary</h2>
